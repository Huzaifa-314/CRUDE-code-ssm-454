<?php
$db = mysqli_connect('localhost', 'root', '', 'varsity');
if (!$db) {
...
if (isset($_POST['saveinfo'])) {
    ...
    $sql2 = "INSERT INTO user(name,email,pass) VALUES ('$name', '$email', '$upass')";
...
if (isset($_GET['id'])) {
    ...
    $sql3 = "DELETE FROM user WHERE id='$del_id'";
...
if (isset($_POST['updateinfo'])) {
    ...
    if (!empty($pass)) {
        $pass = sha1($pass);
        $sql4 = "UPDATE user SET name='$name', email='$email', pass='$pass', role='$role', staus='$status' WHERE id='$id'";
    }
    if (empty($pass)) {
        $sql4 = "UPDATE user SET name='$name', email='$email', role='$role', staus='$status' WHERE id='$id'";
    }
                        ...
                        <form class="my-5" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="role">
                                    <option value="2" <?php if ($role == 2) echo 'selected'; ?>>student</option>
